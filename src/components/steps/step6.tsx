...
export default function Step6({ data, updateFormData, onNext, onBack }: Step6Props) {
  // Combine street and apartment for display
    ...
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold">
          Do you currently rent or own <br /> {displayAddress}?
        </h1>
      ...
      <RadioGroup 
        ...
        onValueChange={(value) => updateFormData({ homeOwnership: value })}
